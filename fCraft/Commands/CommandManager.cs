...
namespace fCraft.Commands {
	...
	public static class CommandManager {
		...
		public static readonly string[] ReservedCommandNames = new string[] {
			"ok", "nvm", "dev"
		};
		...
		public static CommandDescriptor[] GetCommands(bool hidden) {
			return Commands.Values.Where(cmd =>(cmd.IsHidden == hidden))
								  .ToArray();
		}
		...
		public static CommandDescriptor[] GetCommands([NotNull] Rank rank, bool includeHidden) {
			...
			return Commands.Values.Where(cmd =>(!cmd.IsHidden || includeHidden) &&
		...
		/// Command to find.
		/// </param>
		/// <param name="alsoCheckAliases">
		/// Whether to check command aliases.
		/// </param>
		/// 
		/// <returns>
		/// CommandDesriptor object if found, null if not found.
		/// </returns>
		[CanBeNull]
...
namespace fCraft.Events {
	...
	public sealed class CommandRegistringEventArgs : CommandRegisteredEventArgs, ICancellableEvent {
		...
		internal CommandRegistringEventArgs(CommandDescriptor commandDescriptor) : base(commandDescriptor) {
		}
