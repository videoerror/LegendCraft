...
namespace fCraft.Commands {
	...
	/// <summary>
	/// Describes a chat command. Defines properties, permission requirements,
	/// and usage information. Specifies a handler method.
	/// </summary>
	public sealed class CommandDescriptor : IClassy {
		...
		/// </summary>
		public bool UsableByFrozenPlayers {
			get;
		...
		/// May be empty or null. Default: null.
		/// </summary>
		...
		/// Help sub-sections.
		/// </summary>
		public Dictionary<string, string> HelpSections {
			get;
		...
		/// <summary>
		/// Whether this command involves a selection that can be repeated with /static.
		/// Default: false.
		/// </summary>
		public bool RepeatableSelection {
			get;
